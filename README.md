...
|----------|--------------|-------|
| [🚴 Cyclistic Bike-Share Analysis ](https://github.com/deepan-mehta-analytics/Google-Data-Analytics-Capstone-Cyclistic-Excel) | Google Data Analytics Capstone: analyzed two Q1 quarters of ride data to compare casual vs. member behavior. | Python, Excel, Pivot Tables, Charts, Tableau Dashboard, Power-point |
