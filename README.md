...
![Google Cloud](https://img.shields.io/badge/GoogleCloud-GCP-blueviolet)
![BigQuery](https://img.shields.io/badge/BigQuery-FE7A16?logo=googlecloud&logoColor=fff)
![Vertex AI](https://img.shields.io/badge/Vertex%20AI-4285F4?logo=googlecloud&logoColor=fff)
![Cloud Run](https://img.shields.io/badge/Cloud%20Run-4285F4?logo=googlecloud&logoColor=fff)
![Terraform](https://img.shields.io/badge/Terraform-623CE4?logo=terraform&logoColor=fff)
![FastAPI](https://img.shields.io/badge/FastAPI-00599C?logo=fastapi&logoColor=fff)
...
| ⚙️ [Bike Demand ML System](https://github.com/deepan-mehta-analytics/bike-demand-ml-system) | Engineered a production-grade machine learning system with a clear separation between training and inference pipelines, featuring reproducible model persistence, schema-aligned feature engineering, and a FastAPI-based prediction service built on a service-layer architecture. Designed to prevent train–serve skew and support scalable, real-time inference workflows. | Python, FastAPI, Scikit-learn, Pydantic, Joblib, ML Systems Design |
